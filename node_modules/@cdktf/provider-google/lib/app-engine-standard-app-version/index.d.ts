...
export declare function appEngineStandardAppVersionVpcAccessConnectorToTerraform(struct?: AppEngineStandardAppVersionVpcAccessConnectorOutputReference | AppEngineStandardAppVersionVpcAccessConnector): any;
export declare function appEngineStandardAppVersionVpcAccessConnectorToHclTerraform(struct?: AppEngineStandardAppVersionVpcAccessConnectorOutputReference | AppEngineStandardAppVersionVpcAccessConnector): any;
export declare class AppEngineStandardAppVersionVpcAccessConnectorOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string);
    get internalValue(): AppEngineStandardAppVersionVpcAccessConnector | undefined;
    set internalValue(value: AppEngineStandardAppVersionVpcAccessConnector | undefined);
...
export declare class AppEngineStandardAppVersion extends cdktf.TerraformResource {
    ...
    */
    ...
    get automaticScaling(): AppEngineStandardAppVersionAutomaticScalingOutputReference;
    putAutomaticScaling(value: AppEngineStandardAppVersionAutomaticScaling): void;
    ...
    get basicScaling(): AppEngineStandardAppVersionBasicScalingOutputReference;
    putBasicScaling(value: AppEngineStandardAppVersionBasicScaling): void;
    resetBasicScaling(): void;
    get basicScalingInput(): AppEngineStandardAppVersionBasicScaling | undefined;
    private _deployment;
    get deployment(): AppEngineStandardAppVersionDeploymentOutputReference;
    putDeployment(value: AppEngineStandardAppVersionDeployment): void;
    get deploymentInput(): AppEngineStandardAppVersionDeployment | undefined;
    private _entrypoint;
    get entrypoint(): AppEngineStandardAppVersionEntrypointOutputReference;
    putEntrypoint(value: AppEngineStandardAppVersionEntrypoint): void;
    get entrypointInput(): AppEngineStandardAppVersionEntrypoint | undefined;
    private _handlers;
    get handlers(): AppEngineStandardAppVersionHandlersList;
    putHandlers(value: AppEngineStandardAppVersionHandlers[] | cdktf.IResolvable): void;
    resetHandlers(): void;
    get handlersInput(): cdktf.IResolvable | AppEngineStandardAppVersionHandlers[] | undefined;
    private _libraries;
    get libraries(): AppEngineStandardAppVersionLibrariesList;
    putLibraries(value: AppEngineStandardAppVersionLibraries[] | cdktf.IResolvable): void;
    resetLibraries(): void;
    get librariesInput(): cdktf.IResolvable | AppEngineStandardAppVersionLibraries[] | undefined;
    private _manualScaling;
    get manualScaling(): AppEngineStandardAppVersionManualScalingOutputReference;
    putManualScaling(value: AppEngineStandardAppVersionManualScaling): void;
    resetManualScaling(): void;
    get manualScalingInput(): AppEngineStandardAppVersionManualScaling | undefined;
    private _timeouts;
    get timeouts(): AppEngineStandardAppVersionTimeoutsOutputReference;
    putTimeouts(value: AppEngineStandardAppVersionTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | AppEngineStandardAppVersionTimeouts | undefined;
    private _vpcAccessConnector;
    get vpcAccessConnector(): AppEngineStandardAppVersionVpcAccessConnectorOutputReference;
    putVpcAccessConnector(value: AppEngineStandardAppVersionVpcAccessConnector): void;
