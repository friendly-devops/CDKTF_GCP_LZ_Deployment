...
*/
export declare class DataGoogleNotebooksRuntimeIamPolicy extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataGoogleNotebooksRuntimeIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
