...
export declare function storageTransferJobTransferSpecHdfsDataSourceToTerraform(struct?: StorageTransferJobTransferSpecHdfsDataSourceOutputReference | StorageTransferJobTransferSpecHdfsDataSource): any;
export declare function storageTransferJobTransferSpecHdfsDataSourceToHclTerraform(struct?: StorageTransferJobTransferSpecHdfsDataSourceOutputReference | StorageTransferJobTransferSpecHdfsDataSource): any;
export declare class StorageTransferJobTransferSpecHdfsDataSourceOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string);
    get internalValue(): StorageTransferJobTransferSpecHdfsDataSource | undefined;
    set internalValue(value: StorageTransferJobTransferSpecHdfsDataSource | undefined);
    private _path?;
    get path(): string;
    set path(value: string);
    get pathInput(): string | undefined;
...
export declare function storageTransferJobTransferSpecToHclTerraform(struct?: StorageTransferJobTransferSpecOutputReference | StorageTransferJobTransferSpec): any;
export declare class StorageTransferJobTransferSpecOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    private _hdfsDataSource;
    get hdfsDataSource(): StorageTransferJobTransferSpecHdfsDataSourceOutputReference;
    putHdfsDataSource(value: StorageTransferJobTransferSpecHdfsDataSource): void;
    resetHdfsDataSource(): void;
    get hdfsDataSourceInput(): StorageTransferJobTransferSpecHdfsDataSource | undefined;
    ...
    get posixDataSink(): StorageTransferJobTransferSpecPosixDataSinkOutputReference;
    putPosixDataSink(value: StorageTransferJobTransferSpecPosixDataSink): void;
    resetPosixDataSink(): void;
    get posixDataSinkInput(): StorageTransferJobTransferSpecPosixDataSink | undefined;
    private _posixDataSource;
    get posixDataSource(): StorageTransferJobTransferSpecPosixDataSourceOutputReference;
    putPosixDataSource(value: StorageTransferJobTransferSpecPosixDataSource): void;
    resetPosixDataSource(): void;
    get posixDataSourceInput(): StorageTransferJobTransferSpecPosixDataSource | undefined;
...
export declare class StorageTransferJob extends cdktf.TerraformResource {
    ...
    */
    ...
    get eventStream(): StorageTransferJobEventStreamOutputReference;
    putEventStream(value: StorageTransferJobEventStream): void;
    resetEventStream(): void;
    get eventStreamInput(): StorageTransferJobEventStream | undefined;
    private _notificationConfig;
    get notificationConfig(): StorageTransferJobNotificationConfigOutputReference;
    putNotificationConfig(value: StorageTransferJobNotificationConfig): void;
    resetNotificationConfig(): void;
    get notificationConfigInput(): StorageTransferJobNotificationConfig | undefined;
    private _schedule;
