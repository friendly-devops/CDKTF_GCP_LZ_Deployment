...
export declare function cloudIdsEndpointTimeoutsToTerraform(struct?: CloudIdsEndpointTimeouts | cdktf.IResolvable): any;
export declare function cloudIdsEndpointTimeoutsToHclTerraform(struct?: CloudIdsEndpointTimeouts | cdktf.IResolvable): any;
...
export declare class CloudIdsEndpoint extends cdktf.TerraformResource {
    ...
    * @param importFromId The id of the existing CloudIdsEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.14.1/docs/resources/cloud_ids_endpoint#import import section} in the documentation of this resource for the id to use
