...
*/
export declare class DataGooglePubsubSchemaIamPolicy extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "google_pubsub_schema_iam_policy";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataGooglePubsubSchemaIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
