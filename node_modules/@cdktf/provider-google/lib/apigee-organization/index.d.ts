...
export declare function apigeeOrganizationPropertiesPropertyToTerraform(struct?: ApigeeOrganizationPropertiesProperty | cdktf.IResolvable): any;
export declare function apigeeOrganizationPropertiesPropertyToHclTerraform(struct?: ApigeeOrganizationPropertiesProperty | cdktf.IResolvable): any;
export declare class ApigeeOrganizationPropertiesPropertyOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ApigeeOrganizationPropertiesProperty | cdktf.IResolvable | undefined;
    set internalValue(value: ApigeeOrganizationPropertiesProperty | cdktf.IResolvable | undefined);
    private _name?;
    get name(): string;
...
export declare class ApigeeOrganizationPropertiesPropertyList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    internalValue?: ApigeeOrganizationPropertiesProperty[] | cdktf.IResolvable;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    get(index: number): ApigeeOrganizationPropertiesPropertyOutputReference;
}
...
export declare function apigeeOrganizationPropertiesToTerraform(struct?: ApigeeOrganizationPropertiesOutputReference | ApigeeOrganizationProperties): any;
export declare function apigeeOrganizationPropertiesToHclTerraform(struct?: ApigeeOrganizationPropertiesOutputReference | ApigeeOrganizationProperties): any;
export declare class ApigeeOrganizationPropertiesOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    */
    ...
    get internalValue(): ApigeeOrganizationProperties | undefined;
    set internalValue(value: ApigeeOrganizationProperties | undefined);
    private _property;
    get property(): ApigeeOrganizationPropertiesPropertyList;
    putProperty(value: ApigeeOrganizationPropertiesProperty[] | cdktf.IResolvable): void;
    resetProperty(): void;
    get propertyInput(): cdktf.IResolvable | ApigeeOrganizationPropertiesProperty[] | undefined;
}
...
export declare function apigeeOrganizationTimeoutsToTerraform(struct?: ApigeeOrganizationTimeouts | cdktf.IResolvable): any;
export declare function apigeeOrganizationTimeoutsToHclTerraform(struct?: ApigeeOrganizationTimeouts | cdktf.IResolvable): any;
...
export declare class ApigeeOrganization extends cdktf.TerraformResource {
    ...
    * @param importFromId The id of the existing ApigeeOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.14.1/docs/resources/apigee_organization#import import section} in the documentation of this resource for the id to use
    ...
    */
    ...
    private _apiConsumerDataEncryptionKeyName?;
    get apiConsumerDataEncryptionKeyName(): string;
    set apiConsumerDataEncryptionKeyName(value: string);
    resetApiConsumerDataEncryptionKeyName(): void;
    get apiConsumerDataEncryptionKeyNameInput(): string | undefined;
    private _apiConsumerDataLocation?;
    get apiConsumerDataLocation(): string;
    set apiConsumerDataLocation(value: string);
    resetApiConsumerDataLocation(): void;
    get apiConsumerDataLocationInput(): string | undefined;
    ...
    private _controlPlaneEncryptionKeyName?;
    get controlPlaneEncryptionKeyName(): string;
    set controlPlaneEncryptionKeyName(value: string);
    resetControlPlaneEncryptionKeyName(): void;
    get controlPlaneEncryptionKeyNameInput(): string | undefined;
    ...
    private _properties;
    get properties(): ApigeeOrganizationPropertiesOutputReference;
    putProperties(value: ApigeeOrganizationProperties): void;
    resetProperties(): void;
    get propertiesInput(): ApigeeOrganizationProperties | undefined;
    private _timeouts;
