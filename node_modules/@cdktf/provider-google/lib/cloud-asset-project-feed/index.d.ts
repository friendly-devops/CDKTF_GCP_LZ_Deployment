...
export declare function cloudAssetProjectFeedConditionToHclTerraform(struct?: CloudAssetProjectFeedConditionOutputReference | CloudAssetProjectFeedCondition): any;
...
export declare function cloudAssetProjectFeedFeedOutputConfigPubsubDestinationToHclTerraform(struct?: CloudAssetProjectFeedFeedOutputConfigPubsubDestinationOutputReference | CloudAssetProjectFeedFeedOutputConfigPubsubDestination): any;
...
export declare function cloudAssetProjectFeedFeedOutputConfigToHclTerraform(struct?: CloudAssetProjectFeedFeedOutputConfigOutputReference | CloudAssetProjectFeedFeedOutputConfig): any;
...
export declare function cloudAssetProjectFeedTimeoutsToTerraform(struct?: CloudAssetProjectFeedTimeouts | cdktf.IResolvable): any;
export declare function cloudAssetProjectFeedTimeoutsToHclTerraform(struct?: CloudAssetProjectFeedTimeouts | cdktf.IResolvable): any;
export declare class CloudAssetProjectFeedTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string);
    get internalValue(): CloudAssetProjectFeedTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: CloudAssetProjectFeedTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class CloudAssetProjectFeed extends cdktf.TerraformResource {
    ...
    */
    ...
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | CloudAssetProjectFeedTimeouts | undefined;
