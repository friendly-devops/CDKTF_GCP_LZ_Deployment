...
export declare function resourceManagerLienTimeoutsToTerraform(struct?: ResourceManagerLienTimeouts | cdktf.IResolvable): any;
export declare function resourceManagerLienTimeoutsToHclTerraform(struct?: ResourceManagerLienTimeouts | cdktf.IResolvable): any;
export declare class ResourceManagerLienTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ResourceManagerLienTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ResourceManagerLienTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class ResourceManagerLien extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_resource_manager_lien";
    /**
    ...
    */
    ...
    get restrictionsInput(): string[] | undefined;
    private _timeouts;
    get timeouts(): ResourceManagerLienTimeoutsOutputReference;
    putTimeouts(value: ResourceManagerLienTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ResourceManagerLienTimeouts | undefined;
