...
export declare function endpointsServiceApisMethodsToTerraform(struct?: EndpointsServiceApisMethods): any;
export declare function endpointsServiceApisMethodsToHclTerraform(struct?: EndpointsServiceApisMethods): any;
export declare class EndpointsServiceApisMethodsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): EndpointsServiceApisMethods | undefined;
    set internalValue(value: EndpointsServiceApisMethods | undefined);
    get name(): string;
    get requestType(): string;
    get responseType(): string;
    get syntax(): string;
}
export declare class EndpointsServiceApisMethodsList extends cdktf.ComplexList {
    ...
    */
    get(index: number): EndpointsServiceApisMethodsOutputReference;
}
export interface EndpointsServiceApis {
}
export declare function endpointsServiceApisToTerraform(struct?: EndpointsServiceApis): any;
export declare function endpointsServiceApisToHclTerraform(struct?: EndpointsServiceApis): any;
export declare class EndpointsServiceApisOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): EndpointsServiceApis | undefined;
    set internalValue(value: EndpointsServiceApis | undefined);
    private _methods;
    get methods(): EndpointsServiceApisMethodsList;
    get name(): string;
    get syntax(): string;
    get version(): string;
}
export declare class EndpointsServiceApisList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    /**
    ...
    * @param index the index of the item to return
    */
    get(index: number): EndpointsServiceApisOutputReference;
}
export interface EndpointsServiceEndpoints {
}
export declare function endpointsServiceEndpointsToTerraform(struct?: EndpointsServiceEndpoints): any;
export declare function endpointsServiceEndpointsToHclTerraform(struct?: EndpointsServiceEndpoints): any;
export declare class EndpointsServiceEndpointsOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): EndpointsServiceEndpoints | undefined;
    set internalValue(value: EndpointsServiceEndpoints | undefined);
    get address(): string;
    get name(): string;
}
export declare class EndpointsServiceEndpointsList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    /**
    ...
    * @param index the index of the item to return
    */
    get(index: number): EndpointsServiceEndpointsOutputReference;
}
...
export declare function endpointsServiceTimeoutsToTerraform(struct?: EndpointsServiceTimeouts | cdktf.IResolvable): any;
export declare function endpointsServiceTimeoutsToHclTerraform(struct?: EndpointsServiceTimeouts | cdktf.IResolvable): any;
export declare class EndpointsServiceTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): EndpointsServiceTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: EndpointsServiceTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class EndpointsService extends cdktf.TerraformResource {
    ...
    */
    ...
    private _apis;
    get apis(): EndpointsServiceApisList;
    get configId(): string;
    get dnsAddress(): string;
    private _endpoints;
    get endpoints(): EndpointsServiceEndpointsList;
    private _grpcConfig?;
    ...
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | EndpointsServiceTimeouts | undefined;
