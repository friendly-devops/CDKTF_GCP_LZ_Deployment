...
*/
export declare class DataGoogleComputeNetworks extends cdktf.TerraformDataSource {
    static readonly tfResourceType = "google_compute_networks";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config?: DataGoogleComputeNetworksConfig);
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
