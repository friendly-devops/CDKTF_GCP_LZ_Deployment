...
export declare function dataGoogleComputeRegionNetworkEndpointGroupPscDataToTerraform(struct?: DataGoogleComputeRegionNetworkEndpointGroupPscData): any;
export declare function dataGoogleComputeRegionNetworkEndpointGroupPscDataToHclTerraform(struct?: DataGoogleComputeRegionNetworkEndpointGroupPscData): any;
export declare class DataGoogleComputeRegionNetworkEndpointGroupPscDataOutputReference extends cdktf.ComplexObject {
    private isEmptyObject;
    /**
    * @param terraformResource The parent resource
    * @param terraformAttribute The attribute on the parent resource this class is referencing
    ...
    */
    constructor(terraformResource: cdktf.IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean);
    get internalValue(): DataGoogleComputeRegionNetworkEndpointGroupPscData | undefined;
    set internalValue(value: DataGoogleComputeRegionNetworkEndpointGroupPscData | undefined);
    get producerPort(): string;
}
export declare class DataGoogleComputeRegionNetworkEndpointGroupPscDataList extends cdktf.ComplexList {
    protected terraformResource: cdktf.IInterpolatingParent;
    protected terraformAttribute: string;
    protected wrapsSet: boolean;
    /**
    ...
    * @param index the index of the item to return
    */
    get(index: number): DataGoogleComputeRegionNetworkEndpointGroupPscDataOutputReference;
}
/**
...
export declare class DataGoogleComputeRegionNetworkEndpointGroup extends cdktf.TerraformDataSource {
    ...
    */
    ...
    private _pscData;
    get pscData(): DataGoogleComputeRegionNetworkEndpointGroupPscDataList;
