...
*/
export declare class DataGoogleIapAppEngineServiceIamPolicy extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataGoogleIapAppEngineServiceIamPolicyConfig);
    private _appId?;
    get appId(): string;
