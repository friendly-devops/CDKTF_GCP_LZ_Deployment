...
export declare function computeTargetInstanceTimeoutsToTerraform(struct?: ComputeTargetInstanceTimeouts | cdktf.IResolvable): any;
export declare function computeTargetInstanceTimeoutsToHclTerraform(struct?: ComputeTargetInstanceTimeouts | cdktf.IResolvable): any;
export declare class ComputeTargetInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ComputeTargetInstanceTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ComputeTargetInstanceTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
*/
export declare class ComputeTargetInstance extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_compute_target_instance";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: ComputeTargetInstanceConfig);
    ...
    private _natPolicy?;
    get natPolicy(): string;
    set natPolicy(value: string);
    resetNatPolicy(): void;
    get natPolicyInput(): string | undefined;
    private _project?;
    get project(): string;
    ...
    private _timeouts;
    get timeouts(): ComputeTargetInstanceTimeoutsOutputReference;
    putTimeouts(value: ComputeTargetInstanceTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ComputeTargetInstanceTimeouts | undefined;
