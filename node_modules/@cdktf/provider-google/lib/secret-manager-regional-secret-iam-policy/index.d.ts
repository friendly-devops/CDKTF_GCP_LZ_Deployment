...
*/
export declare class SecretManagerRegionalSecretIamPolicy extends cdktf.TerraformResource {
    ...
    */
    constructor(scope: Construct, id: string, config: SecretManagerRegionalSecretIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
