...
export declare function dataGoogleComputeRouterBgpAdvertisedIpRangesToHclTerraform(struct?: DataGoogleComputeRouterBgpAdvertisedIpRanges): any;
...
export declare function dataGoogleComputeRouterBgpToHclTerraform(struct?: DataGoogleComputeRouterBgp): any;
...
export declare class DataGoogleComputeRouter extends cdktf.TerraformDataSource {
    ...
    */
    ...
    get description(): string;
    get encryptedInterconnectRouter(): cdktf.IResolvable;
    private _id?;
    get id(): string;
    set id(value: string);
    resetId(): void;
