...
export declare function computeProjectDefaultNetworkTierTimeoutsToTerraform(struct?: ComputeProjectDefaultNetworkTierTimeouts | cdktf.IResolvable): any;
export declare function computeProjectDefaultNetworkTierTimeoutsToHclTerraform(struct?: ComputeProjectDefaultNetworkTierTimeouts | cdktf.IResolvable): any;
export declare class ComputeProjectDefaultNetworkTierTimeoutsOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): ComputeProjectDefaultNetworkTierTimeouts | cdktf.IResolvable | undefined;
    set internalValue(value: ComputeProjectDefaultNetworkTierTimeouts | cdktf.IResolvable | undefined);
    private _create?;
    get create(): string;
...
export declare class ComputeProjectDefaultNetworkTier extends cdktf.TerraformResource {
    ...
    */
    ...
    putTimeouts(value: ComputeProjectDefaultNetworkTierTimeouts): void;
    resetTimeouts(): void;
    get timeoutsInput(): cdktf.IResolvable | ComputeProjectDefaultNetworkTierTimeouts | undefined;
