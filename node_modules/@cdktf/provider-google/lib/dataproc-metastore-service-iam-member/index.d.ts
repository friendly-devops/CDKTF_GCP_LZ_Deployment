...
export declare function dataprocMetastoreServiceIamMemberConditionToTerraform(struct?: DataprocMetastoreServiceIamMemberConditionOutputReference | DataprocMetastoreServiceIamMemberCondition): any;
export declare function dataprocMetastoreServiceIamMemberConditionToHclTerraform(struct?: DataprocMetastoreServiceIamMemberConditionOutputReference | DataprocMetastoreServiceIamMemberCondition): any;
export declare class DataprocMetastoreServiceIamMemberConditionOutputReference extends cdktf.ComplexObject {
    ...
    */
    ...
    get internalValue(): DataprocMetastoreServiceIamMemberCondition | undefined;
    set internalValue(value: DataprocMetastoreServiceIamMemberCondition | undefined);
...
*/
export declare class DataprocMetastoreServiceIamMember extends cdktf.TerraformResource {
    static readonly tfResourceType = "google_dataproc_metastore_service_iam_member";
    /**
    ...
    */
    constructor(scope: Construct, id: string, config: DataprocMetastoreServiceIamMemberConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
    ...
    private _condition;
    get condition(): DataprocMetastoreServiceIamMemberConditionOutputReference;
    putCondition(value: DataprocMetastoreServiceIamMemberCondition): void;
    resetCondition(): void;
    get conditionInput(): DataprocMetastoreServiceIamMemberCondition | undefined;
