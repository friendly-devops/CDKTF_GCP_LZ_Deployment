...
*/
export declare class DataGoogleComputeImageIamPolicy extends cdktf.TerraformDataSource {
    ...
    */
    constructor(scope: Construct, id: string, config: DataGoogleComputeImageIamPolicyConfig);
    get etag(): string;
    private _id?;
    get id(): string;
    set id(value: string);
